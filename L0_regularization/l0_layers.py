...
class L0Activation(Module):
    ...
    def __init__(self, in_features, out_features=False, bias=False, weight_decay=0., droprate_init=0.5, temperature=2./3.,
    ...
    def _reg_w(self):
        ...
        logpw = ((1 - self.cdf_qz(0)) * logpw_col).sum(1).mean()
        # print(logpw.shape)
